package info.androidhive.DieTryinCam;
...
public class MainActivity extends AppCompatActivity {
    ...
    public TextView txtDescription, person_id, game_id;
    private ImageView imgPreview;
    private VideoView videoPreview;
    public Button btnCapturePicture, btnCapturePictureB, btnCapturePictureC, btnCapturePictureD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCapturePictureC = findViewById(R.id.btnCapturePictureC);
        btnCapturePictureD = findViewById(R.id.btnCapturePictureD);
         ...
         * Capture image on button click
         */
        btnCapturePictureC.setOnClickListener(new View.OnClickListener() {
         ...
         * Capture image on button click
         */
        btnCapturePictureD.setOnClickListener(new View.OnClickListener() {
    ...
    private void captureImageA() {
        ...
        String gameStamp = game_id.getText().toString();
